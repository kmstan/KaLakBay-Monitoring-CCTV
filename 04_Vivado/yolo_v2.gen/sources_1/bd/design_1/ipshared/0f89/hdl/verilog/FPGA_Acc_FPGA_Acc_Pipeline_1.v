...
module FPGA_Acc_FPGA_Acc_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   local_buf_1_we0;
output  [31:0] local_buf_1_d0;
...
reg   [0:0] exitcond142_reg_142;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] exitcond142_fu_98_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond142_fu_98_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond142_reg_142 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        exitcond142_reg_142 <= exitcond142_fu_98_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond142_reg_142 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond142_fu_98_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond142_reg_142 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond142_reg_142 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond142_reg_142 == 1'd0) & (m_axi_DATA_BUS1_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond142_reg_142 == 1'd0) & (m_axi_DATA_BUS1_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((exitcond142_reg_142 == 1'd0) & (m_axi_DATA_BUS1_RVALID == 1'b0));
end
...
assign exitcond142_fu_98_p2 = ((ap_sig_allocacmp_loop_index_load == NUM) ? 1'b1 : 1'b0);

assign local_buf_1_address0 = loop_index_cast_fu_121_p1;

assign local_buf_1_d0 = DATA_BUS1_addr_read_reg_146;
...
endmodule //FPGA_Acc_FPGA_Acc_Pipeline_1
