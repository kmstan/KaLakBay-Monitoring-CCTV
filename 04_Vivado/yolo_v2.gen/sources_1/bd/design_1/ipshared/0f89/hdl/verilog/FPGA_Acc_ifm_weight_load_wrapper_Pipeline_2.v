...
module FPGA_Acc_ifm_weight_load_wrapper_Pipeline_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [4:0] loop_cnts_3;
output  [4:0] local_buf1_1_address0;
output   local_buf1_1_ce0;
output   local_buf1_1_we0;
output  [31:0] local_buf1_1_d0;
...
reg   [4:0] loop_index3_load_reg_135;
reg   [4:0] loop_index3_load_reg_135_pp0_iter1_reg;
reg   [31:0] DATA_BUS_addr_read_reg_144;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index3_cast_fu_119_p1;
reg   [4:0] loop_index3_fu_50;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_loop_index3_load;
wire   [4:0] empty_fu_102_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond2_fu_96_p2 == 1'd0))) begin
            loop_index3_fu_50 <= empty_fu_102_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_fu_50 <= 5'd0;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond2_reg_140 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DATA_BUS_addr_read_reg_144 <= m_axi_DATA_BUS_RDATA;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        exitcond2_reg_140 <= exitcond2_fu_96_p2;
        loop_index3_load_reg_135 <= ap_sig_allocacmp_loop_index3_load;
        loop_index3_load_reg_135_pp0_iter1_reg <= loop_index3_load_reg_135;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond2_reg_140 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2_fu_96_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond2_reg_140 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index3_load = 5'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond2_reg_140 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond2_reg_140 == 1'd0) & (m_axi_DATA_BUS_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond2_reg_140 == 1'd0) & (m_axi_DATA_BUS_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((exitcond2_reg_140 == 1'd0) & (m_axi_DATA_BUS_RVALID == 1'b0));
end
...
assign empty_fu_102_p2 = (ap_sig_allocacmp_loop_index3_load + 5'd1);

assign exitcond2_fu_96_p2 = ((ap_sig_allocacmp_loop_index3_load == loop_cnts_3) ? 1'b1 : 1'b0);

assign local_buf1_1_address0 = loop_index3_cast_fu_119_p1;

assign local_buf1_1_d0 = DATA_BUS_addr_read_reg_144;

assign loop_index3_cast_fu_119_p1 = loop_index3_load_reg_135_pp0_iter1_reg;
...
endmodule //FPGA_Acc_ifm_weight_load_wrapper_Pipeline_2
