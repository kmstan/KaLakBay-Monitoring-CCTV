...
module FPGA_Acc_write_back_output_reorg_Pipeline_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [3:0] local_buf0_address0;
output   local_buf0_ce0;
input  [31:0] local_buf0_q0;
...
reg   [0:0] exitcond3_reg_140;
reg   [31:0] local_buf0_load_reg_154;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond3_fu_101_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_52 <= empty_fu_107_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        exitcond3_reg_140 <= exitcond3_fu_101_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3_reg_140 == 1'd0))) begin
        local_buf0_load_reg_154 <= local_buf0_q0;
    end
end
...
always @ (*) begin
    if (((exitcond3_fu_101_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond3_reg_140 == 1'd1))) begin
...
assign empty_fu_107_p2 = (ap_sig_allocacmp_loop_index_load + 8'd1);

assign exitcond3_fu_101_p2 = ((ap_sig_allocacmp_loop_index_load == loop_cnts_1) ? 1'b1 : 1'b0);

assign local_buf0_address0 = loop_index_cast_fu_113_p1;
...
assign m_axi_DATA_BUS_WDATA = local_buf0_load_reg_154;
...
endmodule //FPGA_Acc_write_back_output_reorg_Pipeline_2
